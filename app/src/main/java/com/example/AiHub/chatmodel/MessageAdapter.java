...
package com.example.AiHub.chatmodel;
...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MyViewHolder>{
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (message.getSentBy().equals(Message.SEND_BY_ME)){
            ...
            //  Toast.makeText(holder.itemView.getContext(), "result"+message.getMessage(), Toast.LENGTH_SHORT).show();
        }

        if(message.getSentBy().equals(Message.SEND_BY_BOT)){
            // Toast.makeText(holder.itemView.getContext(), "BOT : "+message.getMessage().toString(), Toast.LENGTH_SHORT).show();
        }
