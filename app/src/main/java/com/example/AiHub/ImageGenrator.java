...
public class ImageGenrator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_genrator);
    ...
    void callAPI(String text){
        ...
        Request request = new Request.Builder()
                ...
                .header("Authorization","Bearer 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")
                .post(requestBody)
                .build();
